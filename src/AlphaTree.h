...
private:
	...
	static int constexpr FLOOD_HIERARQUEUE = 6;
	static int constexpr FLOOD_HIERARQUEUE_PAR = 7;
	static int constexpr FLOOD_TRIE_CACHE = 8;
	static int constexpr FLOOD_TRIE = 9;
	static int constexpr FLOOD_HEAPQUEUE_CACHE = 10;
	static int constexpr FLOOD_HEAPQUEUE = 11;
	static int constexpr FLOOD_HEAPQUEUE_NAIVE = 12;
	static int constexpr FLOOD_HIERARQUEUE_HYPERGRAPH = 13;
	static int constexpr FLOOD_TRIE_HYPERGRAPH = 14;
	static int constexpr FLOOD_LADDERQUEUE = 15;

	static char constexpr FLOOD_HIERARHEAPQUEUE_CACHE_NUM[] = "0";
	...
	static char constexpr FLOOD_HIERARQUEUE_NUM[] = "6";
	static char constexpr FLOOD_HIERARQUEUE_COMMAND[] = "FloodHierQueueNoCache";
	static char constexpr FLOOD_HIERARQUEUE_PAR_NUM[] = "7";
